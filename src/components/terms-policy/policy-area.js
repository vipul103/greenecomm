          ...
          <div className="col-xl-10">
            <div className="policy__wrapper policy__translate p-relative z-index-1">
              <div className="policy__item mb-35">
                ...
                <p>
                  greenenergypowerco knows that you care about how your personal information
                  is used and shared, and greenenergypowerco takes your privacy seriously.
                  Please read the following to learn more about greenenergypowerco Privacy
                ...
                <p>
                  ...
                  greenenergypowerco will collect, use, and share your information in the
                  following ways. Remember that your use of Services is at all
                  times subject to the Terms as set forth at
                  https://greenenergypowerco.com/legal/terms, which incorporate this Privacy
                  Policy. Any terms greenenergypowerco uses in this Privacy Policy without
                ...
                <div className="policy__address">
                  <p>
                    <a
                      ...
                      target="_blank"
                    >
                     greenenergypowerco PTY LTD <br /> 1333, north road huntingdale, Australia
                    </a>
                  </p>
                </div>
              </div>
